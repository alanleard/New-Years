...
/**
 The base class for all NewYears modules
 */
...
/**
 NewYears Platform calls this method on startup.
 */
-(void)startup;

/**
 NewYears Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NewYears Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NewYears Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 NewYears Platform calls this method on resume.
 @param sender The sender of the event.
 */
