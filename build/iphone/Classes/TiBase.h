...
// in simulator we redefine to format for NewYears Developer console
...
{\
	NSString * exceptionName = [@"org.newyears." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newyears";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINewYearsNativeItemNone = -1, 
	UINewYearsNativeItemSpinner = -2,
	UINewYearsNativeItemProgressBar = -3,
	
	UINewYearsNativeItemSlider = -4,
	UINewYearsNativeItemSwitch = -5,
	UINewYearsNativeItemMultiButton = -6,
	UINewYearsNativeItemSegmented = -7,
	
	UINewYearsNativeItemTextView = -8,
	UINewYearsNativeItemTextField = -9,
	UINewYearsNativeItemSearchBar = -10,
	
	UINewYearsNativeItemPicker = -11,
	UINewYearsNativeItemDatePicker = -12,
	
	UINewYearsNativeItemInfoLight = -13,
	UINewYearsNativeItemInfoDark = -14,
	
	UINewYearsNativeItemDisclosure = -15,
	
	UINewYearsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NewYears instances of
