 ...
 * Copyright (c) 2009-2011 by NewYears, Inc. All Rights Reserved.
...
//@interface NewYearsObject : NSObject
//@end

@interface NewYearsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NewYearsObject class]])
		{
			for (NSString *key in [[(NewYearsObject*)o modules] allKeys])
			{
